 ...
 *   <li>{@link views.impl.ViewImpl#getLayout <em>Layout</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ViewImpl extends MinimalEObjectImpl.Container implements View {
	...
	public void setLayout(Layout newLayout) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ViewsPackage.VIEW__LAYOUT, oldLayout, layout));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ViewsPackage.VIEW__LAYOUT:
				return getLayout();
		}
