...
/**
 * This is the item provider adapter for a {@link views.ClassOperationView} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClassOperationViewItemProvider extends ViewItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ClassOperationView_instance_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ClassOperationView_instance_feature", "_UI_ClassOperationView_type"),
				 ViewsPackage.Literals.CLASS_OPERATION_VIEW__INSTANCE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ViewsPackage.Literals.CLASS_OPERATION_VIEW__VIEW_ELEMENTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ViewsPackage.Literals.CLASS_OPERATION_VIEW__VIEW_ELEMENTS,
