...
/**
 * This is the item provider adapter for a {@link views.Link} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LinkItemProvider extends ViewElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Link_instance_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Link_instance_feature", "_UI_Link_type"),
				 ViewsPackage.Literals.LINK__INSTANCE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addViewPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Link_view_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Link_view_feature", "_UI_Link_type"),
				 ViewsPackage.Literals.LINK__VIEW,
				 true,
				 false,
				 true,
				 null,
