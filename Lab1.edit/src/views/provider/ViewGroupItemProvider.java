...
/**
 * This is the item provider adapter for a {@link views.ViewGroup} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ViewGroupItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ViewGroup_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ViewGroup_name_feature", "_UI_ViewGroup_type"),
				 ViewsPackage.Literals.VIEW_GROUP__NAME,
				 true,
				 false,
				 false,
	...
	protected void addStartViewPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ViewGroup_startView_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ViewGroup_startView_feature", "_UI_ViewGroup_type"),
				 ViewsPackage.Literals.VIEW_GROUP__START_VIEW,
				 true,
				 false,
				 true,
				 null,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ViewsPackage.Literals.VIEW_GROUP__VIEWS,
				 ViewsFactory.eINSTANCE.createClassOperationView()));
	}
