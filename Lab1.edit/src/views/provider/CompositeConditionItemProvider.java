...
/**
 * This is the item provider adapter for a {@link views.CompositeCondition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CompositeConditionItemProvider extends ConditionItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CompositeCondition_operatorType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CompositeCondition_operatorType_feature", "_UI_CompositeCondition_type"),
				 ViewsPackage.Literals.COMPOSITE_CONDITION__OPERATOR_TYPE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ViewsPackage.Literals.COMPOSITE_CONDITION__COND1);
			childrenFeatures.add(ViewsPackage.Literals.COMPOSITE_CONDITION__COND2);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ViewsPackage.Literals.COMPOSITE_CONDITION__COND1,
		...
		newChildDescriptors.add
			(createChildParameter
				(ViewsPackage.Literals.COMPOSITE_CONDITION__COND2,
				 ViewsFactory.eINSTANCE.createComparisonCondition()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == ViewsPackage.Literals.COMPOSITE_CONDITION__COND1 ||
			childFeature == ViewsPackage.Literals.COMPOSITE_CONDITION__COND2;
